...
using BitAdminCoreDemo.Services;
...
namespace BitAdminCoreDemo
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory logger, IServiceProvider svc)
        {
            ...
            //启用Swagger服务
            //app.UseSwagger();
            //app.UseSwaggerUI(options => options.SwaggerEndpoint("/swagger/v1/swagger.json", "BitAdminCoreDemo api v1"));
        }
